---
title: History (retired systems)
nav_exclude: true
---

# Retired systems

Docs for systems Temper has removed, kept for the record. Nothing here is loaded into a
session or wired to a gate — `reference/` is live methodology only; this directory is
