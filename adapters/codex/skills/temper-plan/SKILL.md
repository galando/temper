...
> **Full methodology:** Read `reference/plan.md`

### Quick Reference

1. Detect input (Jira/GitHub/description)
2. Auto-prime via Explore focused inline passes (scan codebase, detect stack, find patterns)
...
Follow `agents/plan.md` steps 3-4 (record `temper state set
...
```
scripts/temper evidence add --stage plan --claim "<what you're proving>" \
